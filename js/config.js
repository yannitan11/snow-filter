...
export const SEASONS = [
  ...
  },
  {
    ...
    blend: "lighter",
    shape: "dot",
    palette: ["#fff2c2", "#ffe08a", "#ffd76a", "#eaffcf", "#ffd0a0", "#fff6e0"],
    phys: {
      gravity: 44, // warm motes drift slowly
      gravityVar: 28,
      wind: 46,
      sway: 42,
      emit: 260,
      ...
      spin: 0,
      drawScale: 6,
      // Sunlit shimmer: each mote pulses in brightness like a firefly.
      twinkle: true,
      twinkleAmp: 0.7,
      twinkleSpeed: 5.5,
    },
  },
  {
    ...
    blend: "source-over",
    shape: "leaf",
    palette: ["#e8792b", "#d24f2a", "#f2a83c", "#c0641f", "#b8862f", "#e0b03a", "#a83c1e"],
    phys: {
      gravity: 96,
      gravityVar: 50,
      wind: 46,
      sway: 0, // superseded by flutter
      emit: 240,
      sizeMin: 8,
      sizeMax: 16,
      alphaMin: 0.92,
      ...
      spin: 2.2,
      drawScale: 3,
      // Leaves tumble down like petals do.
      flutter: true,
      flutterAmp: 82,
      flutterFreqMin: 0.6,
      flutterFreqMax: 1.5,
